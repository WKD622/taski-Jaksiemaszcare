...
public class JuniorDeveloper extends AbstractEmployee {

    public JuniorDeveloper(String name, Role role, String email, String Country, String University, Sex sex){
